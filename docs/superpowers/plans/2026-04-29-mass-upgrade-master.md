...
### ✅ Phase 5: 트래픽 유입 2 — 마케팅 채널 (완료 2026-04-29, 4 commit `f1ddd94`~`6d7be30`)
- **A4** 주간 정책 다이제스트 cron (월 09:00 KST, 알림 규칙 없는 사용자 대상) ✅
- **A3** Referral 시스템 (DDL 068 + Pro 1주 보상 + cap 10 + 자기 추천 4중 가드) ✅
