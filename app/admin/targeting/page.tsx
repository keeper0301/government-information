    ...
    <main className="min-h-screen bg-grey-50 pt-[80px] pb-20">
      <div className="max-w-[980px] mx-auto px-5">
        ...
        <section className="mb-8 space-y-4">
          <h2 className="text-[14px] font-bold text-grey-900 mb-3">분석 진행률</h2>
          {Object.entries(stats).map(([table, s]) => {
            ...
            return (
              ...
              >
                <h3 className="text-[14px] font-bold text-grey-900 mb-3">
                ...
                <div className="text-[12px] text-grey-600 bg-grey-50 rounded-md px-3 py-2 border border-grey-100">
        ...
        <section className="border-2 border-emerald-300 rounded-xl p-5 bg-emerald-50/30 mb-8">
          <h2 className="text-[14px] font-bold text-grey-900 mb-2">
            백필 batch trigger
          </h2>
          <p className="text-[13px] text-grey-700 mb-1">
