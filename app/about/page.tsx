    ...
    <main className="min-h-screen bg-grey-50 pt-[80px] pb-20">
      ...
      <div className="max-w-[720px] mx-auto px-5">
        ...
        <Section title="운영 방식">
          ...
          <p className="mt-3">
            {ADSENSE_REVIEW_MODE
              ? "재심사 기간에는 대량 자동 수집 페이지를 검색엔진 제출 대상에서 줄이고, 사람이 읽을 수 있는 대표 가이드·카테고리 허브·소개/도움말 페이지를 우선 보여줍니다. 정책 상세는 계속 열람할 수 있지만, 자체 해설이 부족한 자동 수집 페이지는 색인보다 원문 확인과 내부 탐색 역할에 가깝게 둡니다."
