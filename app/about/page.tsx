    ...
    <main className="min-h-screen bg-grey-50 pt-[80px] pb-20">
      ...
      <div className="max-w-[720px] mx-auto px-5">
        ...
        <Section title="왜 만들었나요">
          <p>
            정부 정책은 항상 누군가에게 절실합니다. 하지만 &ldquo;내가 받을 수 있는
            정책이 있는데도 몰라서 놓쳤다&rdquo; 는 사연을 너무 자주 봤습니다.
          ...
          <p className="mt-3">
            ...
            &ldquo;내가 받을 수 있는 정책&rdquo; 만 추려서 보여드립니다. 글 하나하나에
        ...
        <Section title="우리가 만들고 싶은 것">
          ...
          <p className="mt-3">
            한 사람의 운영자가 매일 데이터 품질·정확성·접근성을 점검하며 운영합니다.
            대규모 광고나 외부 투자 없이 사용자 신뢰만으로 자생할 수 있는 공공 정보
            서비스를 목표로 하고 있습니다.
          </p>
        </Section>

        {/* 운영자 — AdSense E-E-A-T 신원 신뢰 신호 */}
        <Section title="누가 운영하나요">
          <p>
            정책알리미는 1인 사업자가 직접 운영하는 정보 서비스입니다.
            사용자의 개인정보 보호와 정책 데이터의 정확성에 대한 모든 책임은
            아래 운영자가 직접 집니다.
          </p>
          <ul className="mt-3 space-y-2 text-grey-700">
            <li>
              상호: <b className="text-grey-900">키피오 (keepioo)</b>
            </li>
            <li>
              대표 / 개인정보보호책임자:{" "}
              <b className="text-grey-900">최관철</b>
            </li>
            <li>사업자 등록번호: 657-24-02265</li>
            <li>통신판매업 신고번호: 2026-전남순천-7182</li>
            <li>서비스 운영 시작: 2026년 4월</li>
            <li>
              호스팅 / 인프라: Vercel · Supabase · Resend (해외 인프라 사용,
              개인정보처리방침 명시)
            </li>
          </ul>
          <p className="mt-3 text-[13px] text-grey-600">
            사용자 데이터는 위 운영자만 접근하며, 광고·마케팅 제3자에게 판매하지
            않습니다. 자세한 처리 항목은{" "}
        ...
        <Section title="지금 정책알리미는">
          ...
          <ul className="mt-3 space-y-2 text-grey-700">
            ...
            <li>
              <b className="text-grey-900">신청 전 확인 순서</b>: 정책을 보기 전에
              자격, 준비 서류, 공식 원문, 마감 상태를 먼저 확인하도록 안내합니다.
            </li>
            {!ADSENSE_REVIEW_MODE && (
              <li>
        ...
        <Section title="정확성을 어떻게 보완하나요">
          <p>
            정책알리미는 정부·지자체 원문을 그대로 복사해 끝내지 않습니다. 사용자에게
            필요한 판단 기준인 대상 조건, 제출 서류, 중복 수급 제한, 마감·예산 소진
            가능성을 별도 가이드와 허브 설명으로 보완합니다.
          </p>
          <p className="mt-3">
            다만 최종 신청 권한은 각 기관에 있습니다. 그래서 모든 상세 페이지에는
            공식 원문 또는 신청처 링크를 두고, 애매한 조건은 담당 기관에 확인하도록
            안내합니다. 이 선을 넘겨 확정적으로 받을 수 있다고 과장하지 않습니다.
          </p>
        </Section>
        ...
        <Section title={ADSENSE_REVIEW_MODE ? "운영 기준" : "서비스 운영 비용"}>
          {ADSENSE_REVIEW_MODE ? (
            <p>
              재심사 기간에는 광고·가입 전환보다 정보 품질을 우선합니다. 대표 가이드,
              카테고리 허브, 편집·출처·정정 정책처럼 사람이 읽고 확인할 수 있는 페이지를
              중심으로 공개하고, 신청 가능 여부는 각 기관 공식 원문에서 최종 확인하도록 안내합니다.
            </p>
          ) : (
            <p>
