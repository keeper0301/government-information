...
// 2026-06-13 — 정적 ISR on-demand. 빈 배열 = 빌드 시 prebuild 0, 모든 id 는 첫 요청 시
// 렌더 후 revalidate(1h) 동안 CDN 캐시(ISR). dynamicParams 기본 true 라 새 id 도 정상 처리.
// (이게 있어야 dynamic param 라우트가 ƒ 완전동적이 아닌 ● ISR 캐시로 잡힌다.)
