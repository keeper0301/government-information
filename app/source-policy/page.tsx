...
export default function SourcePolicyPage() {
  return (
    <main className="container mx-auto max-w-3xl px-4 py-10">
      ...
      <section className="mt-8 space-y-4 leading-relaxed text-gray-700">
        <h2 className="text-xl font-bold text-grey-900">자동 수집 자료의 처리</h2>
        <p>
          정책알리미는 공개 데이터와 공공기관 페이지를 참고해 정책 목록을 정리할 수 있습니다. 다만 자동 수집된 문장은 그대로 신뢰하지 않고, 사용자가 신청 판단에 쓰는 가이드에서는 대상·서류·마감·중복 제한을 다시 사람이 읽을 수 있는 형태로 정리합니다.
        </p>
        <p>
