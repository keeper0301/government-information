    ...
    <main className="pt-28 pb-20 max-w-content mx-auto px-6 lg:px-10">
      ...
      <div className="text-[15px] text-grey-700 leading-[1.8] space-y-6">
        ...
        <section>
          ...
          <p>③ 회사는 결제 화면에서 상품명, 가격, 무료체험 기간, 자동결제 조건, 해지 방법을 명확히 안내하고 회원의 동의를 받은 뒤 결제를 진행합니다. 결제 완료·실패·구독 상태 변경과 관련한 안내는 이메일 또는 서비스 내 알림으로 발송할 수 있습니다.</p>
        </section>
        <section>
          ...
          <p>② 현재 결제된 주기 중 미사용 일수에 대한 일할 계산 환불은 디지털 콘텐츠·정보 안내 서비스의 특성상 원칙적으로 제공되지 않습니다. 다만 관계 법령상 청약철회 또는 환불이 필요한 경우에는 법령을 우선 적용합니다.</p>
          <p>③ 다음 경우에는 결제 전액 환불이 가능합니다.</p>
          <ul className="list-disc pl-6 space-y-1">
            <li>가. 회사의 귀책사유 (서비스 장애, 결제 오류 등) 로 서비스를 이용하지 못한 경우</li>
            <li>나. 결제 후 7일 이내에 환불을 요청하고, 해당 기간 동안 회원이 유료 기능을 사용하지 않은 경우</li>
          </ul>
          <p>④ 회원이 결제 후 유료 기능을 사용하거나 맞춤형 유료 정보 제공이 시작된 경우에는 디지털 콘텐츠 제공 개시로 보아 청약철회가 제한될 수 있습니다. 회사는 결제 전 이 제한 사유를 명확히 안내합니다.</p>
