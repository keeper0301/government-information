      ...
      },
      {
        ...
        a: (
          <>
            ...
            에서 부모님의 나이·지역·상황을 입력하면 해당되는 복지·지원 정책을 모아
            보여드려요. 각 정책 상세에서 신청 조건과 마감일을 확인하고, 실제 신청은
            안내된 공식 사이트에서 진행하시면 됩니다.
          </>
        ),
      },
      {
    ...
    items: [
      {
        ...
        a: (
          <>
            ...
            {ADSENSE_REVIEW_MODE ? " 정기적으로 확인해 정리합니다." : " 매일 자동 수집해서 정리합니다."}
            <br />
            <br />
      ...
      },
      {
        ...
        a: (
          <>
            공고는 {ADSENSE_REVIEW_MODE ? "정기적으로 확인·갱신되고" : "매일 자동 수집되고"}, 일부 소스는 하루에 여러 번 갱신해요.
