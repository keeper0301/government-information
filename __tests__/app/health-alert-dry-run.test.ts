...
describe("health-alert dry-run wiring", () => {
  ...
  it("exposes scoped local-press recovery endpoints for currently stale cities", () => {
    ...
    expect(workflowSource).toContain("- scrape-local-press-gapyeong");
    expect(workflowSource).toContain(
      'path="/api/cron/scrape-local-press?cities=gapyeong"',
    );
    expect(workflowSource).toContain("- scrape-local-press-yeoncheon");
    expect(workflowSource).toContain(
      'path="/api/cron/scrape-local-press?cities=yeoncheon"',
    );
    expect(workflowSource).toContain("- scrape-local-press-sokcho");
    expect(workflowSource).toContain(
      'path="/api/cron/scrape-local-press?cities=sokcho"',
    );
    expect(workflowSource).toContain("- scrape-local-press-hoengseong");
    expect(workflowSource).toContain(
      'path="/api/cron/scrape-local-press?cities=hoengseong"',
    );
    expect(workflowSource).toContain("- scrape-local-press-yeongwol");
    expect(workflowSource).toContain(
    ...
    expect(workflowSource).toContain("- scrape-local-press-jeongseon");
    expect(workflowSource).toContain(
      'path="/api/cron/scrape-local-press?cities=jeongseon"',
    );
