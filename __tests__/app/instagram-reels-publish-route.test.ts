...
beforeEach(() => {
  ...
  mocks.candidate = {
    ...
    instagram_reel_video_url: "https://cdn.keepioo.com/reels/2026-08/article-readable-v14/123-slug-1.mp4",
  ...
  it("reports ready without calling Graph publish", async () => {
    ...
    expect(body).toMatchObject({
      ...
      candidate: {
        ...
        slug: "slug-1",
        attempt_count: 0,
        videoUrl: "https://cdn.keepioo.com/reels/2026-08/article-readable-v14/123-slug-1.mp4",
      },
    });
    expect(mocks.publishReel).not.toHaveBeenCalled();
