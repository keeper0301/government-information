...
describe("종로구 parseDetailBody (view_type01 td.output)", () => {
  const LONG =
    "종로구가 북촌 내 급증하는 한옥체험업으로 인한 주민 불편을 줄이고 정주환경을 보호하기 위해 북촌 지구단위계획 정비를 추진한다고 밝혔다. 그동안 북촌 한옥마을은 관광객이 크게 늘면서 소음과 쓰레기, 주차 문제 등으로 거주 주민들이 불편을 겪어 왔다. 이에 구는 한옥체험업의 무분별한 확산을 막고 주거지로서의 기능을 회복하기 위해 용도 제한과 건축 규제를 정비하기로 했다. 또한 주민 의견을 충분히 수렴하기 위해 공청회와 설명회를 단계적으로 열어 정비 방향을 함께 논의할 계획이다. 구 관계자는 주민이 안심하고 거주할 수 있는 환경을 만드는 데 최선을 다하겠다고 전했다.";
