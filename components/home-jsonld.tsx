...
const FAQS = [
  ...
  {
    q: "맞춤 매칭은 어떻게 작동하나요?",
    a: "지역·나이대·직업·소득·가구 상태 등 7개 조건으로 정책 태그와 자동 매칭됩니다. 한 번 입력하면 새 정책이 추가될 때마다 매칭 결과가 자동 갱신되고, 본인 자격에 맞는 정책만 알림으로 받습니다.",
  },
  {
    q: "운영자는 누구인가요?",
    a: "전남 순천에서 1인 운영하는 키피오(대표 최관철)가 만든 서비스입니다. 자영업자 본인이 정부 정책 찾기 어려움을 겪으면서 만들었고, 사업자등록·통신판매번호·개인정보보호책임자 모두 등록된 정식 서비스입니다.",
  },
];
