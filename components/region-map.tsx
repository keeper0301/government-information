...
//
// 구조: 이 파일은 server component — DB fetch 후 props 로 client 컴포넌트
// (RegionMapSvg) 에 전달. 지도 SVG 자체는 react19-simple-maps 가
// d3-geo 사용하므로 client 측에서 렌더링.
//
...
// 17개 시·도 짧은 이름 (TopoJSON 풀네임과 매핑은 client 컴포넌트에서)
const SIDO_NAMES = [
  "서울", "경기", "인천", "강원",
  "충북", "충남", "세종", "대전",
  "전북", "전남", "광주",
...
export async function RegionMap() {
  // 단일 RPC 호출 (react cache 로 같은 요청 안 다른 호출자와 결과 공유)
