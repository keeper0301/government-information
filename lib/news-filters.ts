...
// false positive 방지: 제목 시작 (^) 이고 인명이 한글 2-3자에 한정.
const POLITICAL_ACTION_TITLE = /^[가-힣]{2,3}\s*,\s*.{0,30}(?:공약\s*발표|출마\s*선언|경선|기자회견|단식\s*투쟁|장외\s*투쟁|예방\s*인사|동행\s*방문|간담회\s*개최|취임식|발족식)/;
