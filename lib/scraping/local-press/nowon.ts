...
// ============================================================
// ⚠️ 2026-05-29 비활성 — 정적 fetch 로 본문(무클래스 span 조각) 추출 불가.
// Playwright PC 러너(playwright/lib/cities.mjs scrapeNowon)로 이관됨.
// _registry.ts 에서 주석 처리되어 이 파일은 현재 미사용(참고용 보존).
// ============================================================
