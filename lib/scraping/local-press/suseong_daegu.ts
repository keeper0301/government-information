// ============================================================
// 대구 수성구 보도자료 수집 (2026-07-27)
// ============================================================
// 공식 보도자료: /index.do?menu_id=00000070
// 목록/상세: iCMS BBSMSTR_000000000019, fn_icms_navi_common('view', '<nttId>')
...
const BASE_URL = "https://www.suseong.kr";
const MENU_ID = "00000070";
const BBS_ID = "BBSMSTR_000000000019";
...
const collector = createPressCollector({
  ...
  region: "대구",
  ministry: "대구 수성구청",
  sourceOutlet: "대구 수성구청",
  sourceCode: "local-press-suseong-daegu",
  listUrl: LIST_URL,
  parseListItems,
  parseDetailBody,
});

export const scrapeSuseongDaeguAndInsert = collector.scrapeAndInsert;
