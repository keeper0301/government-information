// ============================================================
// 대구 달서구 보도·해명 자료 수집 (2026-07-27)
// ============================================================
// 공식 보도·해명 자료: /index.do?menu_id=10000106
// 목록/상세: iCMS BBS_00038, fn_icms_navi_common('view', '<nttId>')
...
const BASE_URL = "https://www.dalseo.daegu.kr";
const MENU_ID = "10000106";
const BBS_ID = "BBS_00038";
...
const collector = createPressCollector({
  ...
  region: "대구",
  ministry: "대구 달서구청",
  sourceOutlet: "대구 달서구청",
  sourceCode: "local-press-dalseo-daegu",
  listUrl: LIST_URL,
  parseListItems,
  parseDetailBody,
});

export const scrapeDalseoDaeguAndInsert = collector.scrapeAndInsert;
