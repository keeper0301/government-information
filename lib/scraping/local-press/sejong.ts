...
// 2026-06-07 — 제목 시작 [가-힣] 강제는 따옴표(‘)·영문 시작 제목을 누락하는 버그(포항
// 동일 패턴). 검증 결과 세종 누락 4건/40%. 시작 제약 제거 + 한글 포함 검사는 parseListPage.
const LIST_ITEM_REGEX =
  /<a\s+href="\/bbs\/R0079\/view\.do\?nttId=([A-Za-z0-9]+)[^"]*"[^>]*>\s*([^<]{4,}?)\s*<\/a>/g;
