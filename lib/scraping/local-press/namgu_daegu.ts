// ============================================================
// 대구 남구 언론브리핑 수집 (2026-07-27)
// ============================================================
// 공식 언론브리핑: /index.do?menu_id=00000854
// 목록/상세: iCMS BBSMSTR_000000000216, fn_icms_navi_common('view', '<nttId>')
...
const BASE_URL = "https://www.nam.daegu.kr";
const MENU_ID = "00000854";
const BBS_ID = "BBSMSTR_000000000216";
const BBS_TY_CODE = "BBST03";
const BBS_ATTRB_CODE = "BBSA01";
...
const collector = createPressCollector({
  ...
  ministry: "대구 남구청",
  sourceOutlet: "대구 남구청",
  sourceCode: "local-press-namgu-daegu",
  listUrl: LIST_URL,
  parseListItems,
  parseDetailBody,
});

export const scrapeNamguDaeguAndInsert = collector.scrapeAndInsert;
