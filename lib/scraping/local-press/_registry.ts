...
import { scrapeSangjuAndInsert } from "./sangju";
...
import { scrapePocheonAndInsert } from "./pocheon";
import { scrapeYeojuAndInsert } from "./yeoju";
import { scrapeDongducheonAndInsert } from "./dongducheon";
...
import { scrapeSokchoAndInsert } from "./sokcho";
import { scrapeHoengseongAndInsert } from "./hoengseong";
import { scrapeYeongwolAndInsert } from "./yeongwol";
import { scrapePyeongchangAndInsert } from "./pyeongchang";
import { scrapeJeongseonAndInsert } from "./jeongseon";
...
import { scrapeYangyangAndInsert } from "./yangyang";
import { scrapeGunsanAndInsert } from "./gunsan";
import { scrapeImsilAndInsert } from "./imsil";
...
import { scrapeDalseoDaeguAndInsert } from "./dalseo_daegu";
import { scrapeDalseongDaeguAndInsert } from "./dalseong_daegu";
import { scrapeGunwiDaeguAndInsert } from "./gunwi_daegu";
...
import { scrapeUljuUlsanAndInsert } from "./ulju_ulsan";
...
export const CITY_REGISTRY: CityEntry[] = [
  ...
  },
  {
    ...
    city: "김천시",
    ministry: "경북 김천시청",
    siteUrl: "https://www.gc.go.kr/portal/bbs/list.do?ptIdx=1944&mId=1203060000",
    fn: scrapeGimcheonAndInsert,
  },
  {
    key: "andong",
    city: "안동시",
  ...
  },
  {
    ...
    city: "상주시",
    ministry: "경북 상주시청",
    siteUrl: "https://www.sangju.go.kr/page/10330/10640.tc",
    fn: scrapeSangjuAndInsert,
  },
  {
    key: "iksan",
    city: "익산시",
  ...
  {
    key: "gwangju_gyeonggi",
    city: "경기 광주시",
    ministry: "경기도 광주시청",
    siteUrl: "https://www.gjcity.go.kr/portal/bbs/list.do?ptIdx=22&mId=0203010000",
    fn: scrapeGwangjuGyeonggiAndInsert,
  },
  {
    key: "osan",
    city: "오산시",
    ministry: "경기도 오산시청",
    siteUrl: "https://www.osan.go.kr/portal/contents.do?mId=0301080000",
    fn: scrapeOsanAndInsert,
  },
  {
    key: "icheon",
    city: "이천시",
  ...
  },
  {
    ...
    city: "포천시",
    ministry: "경기도 포천시청",
    siteUrl: "https://www.pocheon.go.kr/www/selectBbsNttList.do?bbsNo=5014&key=3731",
    fn: scrapePocheonAndInsert,
  },
  {
    key: "yeoju",
    city: "여주시",
    ministry: "경기도 여주시청",
    siteUrl:
      "https://www.yeoju.go.kr/www/selectEminwonNewsList.do?key=422&pageUnit=10&pageIndex=1&searchCnd=all",
    fn: scrapeYeojuAndInsert,
  },
  {
    key: "dongducheon",
    city: "동두천시",
    ministry: "경기도 동두천시청",
    siteUrl: "https://www.ddc.go.kr/ddc/selectBbsNttList.do?bbsNo=95&key=1914",
    fn: scrapeDongducheonAndInsert,
  },
  {
    key: "gwacheon",
    city: "과천시",
    ministry: "경기도 과천시청",
    siteUrl: "https://www.gccity.go.kr/portal/newsList/list.do?mId=0301140100",
    fn: scrapeGwacheonAndInsert,
  },
  {
    key: "yangpyeong",
    city: "양평군",
    ministry: "경기도 양평군청",
    siteUrl: "https://www.yp21.go.kr/www/selectBbsNttList.do?bbsNo=2&key=1112",
    fn: scrapeYangpyeongAndInsert,
  },
  {
    key: "gapyeong",
    city: "가평군",
  ...
  },
  {
    ...
    siteUrl: "https://sokcho.go.kr/sc/portal/sokchonews/pressrelease",
    fn: scrapeSokchoAndInsert,
  },
  {
    key: "hoengseong",
    city: "횡성군",
    ministry: "강원특별자치도 횡성군청",
    siteUrl: "https://www.hsg.go.kr/www/selectBbsNttList.do?key=827&bbsNo=67",
    fn: scrapeHoengseongAndInsert,
  },
  {
    key: "yeongwol",
    city: "영월군",
    ministry: "강원특별자치도 영월군청",
    siteUrl: "https://www.yw.go.kr/www/selectBbsNttList.do?bbsNo=19&key=21",
    fn: scrapeYeongwolAndInsert,
  },
  {
    key: "pyeongchang",
    city: "평창군",
    ...
    siteUrl:
      "https://www.pc.go.kr/portal/government/government-press/government-press-press",
    fn: scrapePyeongchangAndInsert,
  },
  {
    key: "jeongseon",
    city: "정선군",
    ...
    siteUrl:
      "https://www.jeongseon.go.kr/portal/openadmin/adminnews/pressrelease",
    fn: scrapeJeongseonAndInsert,
  },
  {
    key: "hwacheon",
    city: "화천군",
    ministry: "강원특별자치도 화천군청",
    siteUrl: "https://www.ihc.go.kr/media/selectBbsNttList.do?bbsNo=91&key=900",
    fn: scrapeHwacheonAndInsert,
  },
  {
    key: "yanggu",
    city: "양구군",
    ministry: "강원특별자치도 양구군청",
    siteUrl: "https://www.yanggu.go.kr/user_sub?gfnc=www&mu_idx=232",
    fn: scrapeYangguAndInsert,
  },
  {
    key: "inje",
    city: "인제군",
  ...
  },
  {
    ...
    siteUrl: "https://www.yangyang.go.kr/gw/portal/yyc_news_report",
    fn: scrapeYangyangAndInsert,
  },
  {
    key: "gunsan",
    city: "군산시",
    ministry: "전북특별자치도 군산시청",
    siteUrl: "http://eminwon.gunsan.go.kr/emwp/jsp/ofr/OfrNewsEpctLSub.jsp?news_epct_yn=1,2",
    fn: scrapeGunsanAndInsert,
  },
  {
    key: "imsil",
    city: "임실군",
    ministry: "전북특별자치도 임실군청",
    siteUrl: "https://www.imsil.go.kr/index.imsil?menuCd=DOM_000000103002001000",
    fn: scrapeImsilAndInsert,
  },
  ...
  },
  {
    ...
    city: "부산 남구",
    ministry: "부산 남구청",
    siteUrl: "https://www.bsnamgu.go.kr/index.namgu?menuCd=DOM_000000105001004000",
    fn: scrapeBsnamguEminwonAndInsert,
  },
  {
    key: "haeundae",
    city: "부산 해운대구",
    ministry: "부산 해운대구청",
    siteUrl: "https://www.haeundae.go.kr/index.do?menuCd=DOM_000000104001003001",
    fn: scrapeHaeundaeEminwonAndInsert,
  },
  {
    key: "saha",
    city: "부산 사하구",
  ...
  },
  {
    ...
    city: "대구 동구",
    ministry: "대구 동구청",
    siteUrl: "https://www.dong.daegu.kr/portal/contents.do?mid=0201070000",
    fn: scrapeDongguDaeguAndInsert,
  },
  {
    key: "seogu_daegu",
    city: "대구 서구",
  ...
  },
  {
    ...
    city: "대구 달서구",
    ministry: "대구 달서구청",
    siteUrl: "https://www.dalseo.daegu.kr/index.do?menu_id=10000106",
    fn: scrapeDalseoDaeguAndInsert,
  },
  {
    key: "dalseong_daegu",
    city: "대구 달성군",
    ministry: "대구 달성군청",
    siteUrl: "https://www.dalseong.daegu.kr/index.do?menu_id=00000195",
    fn: scrapeDalseongDaeguAndInsert,
  },
  {
    key: "gunwi_daegu",
    city: "대구 군위군",
    ministry: "대구 군위군청",
    siteUrl: "https://www.gunwi.go.kr/ko/page.do?mnu_uid=106",
    fn: scrapeGunwiDaeguAndInsert,
  },
  {
    key: "junggu_ulsan",
    city: "울산 중구",
    ministry: "울산 중구청",
    siteUrl: "https://www.junggu.ulsan.kr/board/list.ulsan?boardId=BBS_0000090&menuCd=DOM_000000102003002000",
    fn: scrapeJungguUlsanAndInsert,
  },
  {
    key: "namgu_ulsan",
    city: "울산 남구",
    ministry: "울산 남구청",
    siteUrl: "https://www.ulsannamgu.go.kr/cop/bbs/selectBoardList.do?bbsId=press",
    fn: scrapeNamguUlsanAndInsert,
  },
  {
    key: "donggu_ulsan",
    city: "울산 동구",
  ...
  },
  {
    ...
    city: "울산 울주군",
    ministry: "울산 울주군청",
    siteUrl: "https://www.ulju.ulsan.kr/ulju/bbs/list.do?ptIdx=146&mId=0404020000",
    fn: scrapeUljuUlsanAndInsert,
  },
  {
    key: "yuseong",
    city: "대전 유성구",
