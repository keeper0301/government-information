// ============================================================
// 부산 사상구청 보도자료 수집 (2026-05-27) — 부산 자치구 batch
// ============================================================
// 사상구 인구 21만. 부산진·금정·동래·북 동일 SI CMS.
...
const BASE_URL = "https://www.sasang.go.kr";
const LIST_URL =
  "https://www.sasang.go.kr/board/list.sasang?boardId=BBS_0000001&menuCd=DOM_000000103001005000";

const LIST_ITEM_REGEX =
  /<a[^>]*href="(\/board\/view\.sasang\?[^"]*boardId=BBS_0000001[^"]*dataSid=(\d+)[^"]*)"[^>]*>([\s\S]{0,500}?)<\/a>/g;
...
export const { scrapeAndInsert: scrapeSasangAndInsert } = createPressCollector(
  {
    cityName: "사상구",
    region: "부산",
    ministry: "사상구청",
