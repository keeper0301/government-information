// ============================================================
// 동래구청 보도자료 수집 (2026-05-27) — 부산 자치구 batch
// ============================================================
// 동래구 인구 27만. 부산진·금정 동일 SI CMS.
// list: /board/list.dongnae?boardId=BBS_0000001&menuCd=DOM_000000103001005000
// ============================================================
...
const BASE_URL = "https://www.dongnae.go.kr";
const LIST_URL =
  "https://www.dongnae.go.kr/board/list.dongnae?boardId=BBS_0000001&menuCd=DOM_000000103001005000";

const LIST_ITEM_REGEX =
  /<a[^>]*href="(\/board\/view\.dongnae\?[^"]*boardId=BBS_0000001[^"]*dataSid=(\d+)[^"]*)"[^>]*>([\s\S]{0,500}?)<\/a>/g;
...
export const { scrapeAndInsert: scrapeDongnaeAndInsert } = createPressCollector(
  {
    cityName: "동래구",
    region: "부산",
    ministry: "동래구청",
