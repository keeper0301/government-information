...
export function getPostCheckoutActivationCopy(
  ...
  if (tier === "pro") {
    return {
      ...
      actions: [
        { href: "/mypage#consents", label: "카카오 동의 켜기", tone: "primary" },
        { href: "/mypage/notifications", label: "알림 조건 설정하기", tone: "secondary" },
      ],
    };
  }
  ...
  return {
    ...
    actions: [
      { href: "/mypage/business", label: "사업자 정보 입력하기", tone: "primary" },
      { href: "/mypage/notifications", label: "이메일 알림 설정하기", tone: "secondary" },
    ],
  };
}
