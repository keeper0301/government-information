...
6. **분량 (절대 준수 — 가장 중요한 룰)**: 본문 순수 텍스트 **1,700~2,300자** 필수.
   - HTML 태그 제외 순수 한글 글자수 기준.
   - 🚨 **1,000자 미만이면 AdSense 정책상 발행 거부 → 즉시 실패**. 절대 짧게 쓰지 말 것.
   - **2,500자 절대 초과 금지**.
   - 짧으면 자격·금액·신청 절차를 H3·table·ul·ol 로 더 구체화 (예시·체크리스트·단계별 안내 추가).
...
<table><tr><th>지원 대상</th><td>...</td></tr><tr><th>지원 금액</th><td><strong>월 N만 원</strong></td></tr><tr><th>신청 기간</th><td>...</td></tr></table>
...
- 호기심 자극 표현 활용: "놓치면", "마감 임박", "올해까지", "자격 1분 확인"
  (광고성 X 정보 구체성 ↑ — AdSense 위반 안 됨)
